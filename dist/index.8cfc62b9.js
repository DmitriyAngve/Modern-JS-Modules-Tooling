...
(0, _shoppingCartJsDefault.default)("pizza", 2); // 2 pizza added to cart
(0, _shoppingCartJsDefault.default)("bread", 5); // 2 pizza added to cart
(0, _shoppingCartJsDefault.default)("oil", 2); // 2 pizza added to cart
(0, _shoppingCartJsDefault.default)("apples", 2); // 2 pizza added to cart
...
const cart = []; // all to-level variable is a private for this MODULE
const addToCart = function(product, quantity) {
    cart.push({
        product,
        quantity
...
},{"./_getTag.js":"1kCom","./isObjectLike.js":"iad76","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["2mNKm","6rimH"], "6rimH", "parcelRequiredc56")
